...
<head>
    ...
    <title>About Us - Hira Property</title>
...
<body>
    ...
    <div class="page-header">
        ...
        <h1>About Hira Property</h1>
        <p>Gujrat's trusted rental management platform</p>
    </div>

    <!-- ABOUT US -->
    <section class="about-band" id="about">
        <div class="inner-max" style="padding: 80px 40px;">
    ...
    <section class="team-section">
        <div class="inner-max">
            <div class="section-header">
                ...
                <p>Final Year Project — BS Information Technology</p>
            </div>
            <div class="team-grid">
                <div class="team-card">
                    <div class="team-avatar">Z</div>
                    <h4>Zunaisha Maqsood</h4>
                    <div class="role">Lead Developer</div>
                    <p>Backend development, database design & system architecture</p>
                    <a href="mailto:aiza38935@gmail.com" class="team-email">✉ aiza38935@gmail.com</a>
                </div>
                <div class="team-card">
                    <div class="team-avatar">H</div>
                    <h4>Hooria Arif</h4>
                    <div class="role">Frontend Developer</div>
                    <p>UI/UX design, frontend development & testing</p>
                    <a href="mailto:hooriaBoo@gmail.com" class="team-email">✉ hooriaBoo@gmail.com</a>
                </div>
                <div class="team-card">
                    <div class="team-avatar">J</div>
                    <h4>Javeria Zahid</h4>
                    <div class="role">Database Analyst</div>
                    <p>Database management, documentation & reporting</p>
                    <a href="mailto:javeriazahid80@gmail.com" class="team-email">✉ javeriazahid80@gmail.com</a>
                </div>
                <div class="team-card">
                    <div class="team-avatar">N</div>
                    <h4>Nayab Bano</h4>
                    <div class="role">System Analyst</div>
                    <p>Requirements analysis, use case design & testing</p>
                    <a href="mailto:banonayyab175@gmail.com" class="team-email">✉ banonayyab175@gmail.com</a>
                </div>
            </div>
        </div>
    </section>
