...
<head>
    ...
    <title>How It Works - Hira Property</title>
...
<body>
    ...
    <div class="page-header">
        ...
        <h1>How It Works</h1>
        <p>Rent your perfect property in 4 simple steps</p>
    </div>
        ...
        <div class="inner-max">
            <div class="steps-grid">
                <div class="step-item">
                    ...
                    <h4>Register</h4>
                    <p>Create your account as Owner or Tenant — free & easy</p>
                </div>
                <div class="step-item">
                    <div class="step-num">2</div>
                    <h4>Browse & Visit</h4>
                    <p>Search properties and schedule a physical site visit</p>
                </div>
                <div class="step-item">
                    <div class="step-num">3</div>
                    <h4>Sign Contract</h4>
                    <p>Manager creates a digital lease agreement for you</p>
                </div>
                <div class="step-item">
                    <div class="step-num">4</div>
                    <h4>Pay & Move In</h4>
                    <p>Pay rent securely via PayFast gateway & move in!</p>
                </div>
            </div>
            <div style="text-align:center; margin-top:50px;">
                <a href="register.php" 
                   style="color:#fff; background:var(--ember); text-decoration:none; padding:13px 32px; border-radius:7px; font-size:14px; font-weight:600;">
                    Get Started Now →
                </a>
            </div>
        </div>
